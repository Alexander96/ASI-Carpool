...
var data = [],
  ...
  for(i = 0; i < 500; i++) {
    ...
    end = new Date(y, m, d, h + 2, m);
    data.push({ title: 'Travel to ' + names[c1 % names.length], start: new Date(y, m, d, h, m), end: end, allDay: false, text: slipsum[c % slipsum.length ] });
  }
